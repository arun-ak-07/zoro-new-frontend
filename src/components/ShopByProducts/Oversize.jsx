    ...
    const cat = async () => {
        try{
            if(productTypeFilters === ''){
                const response = await axios.post(`${backendUrl}/Users/getCategory/${productTypeFilters}`)
            setProductData(response.data)
            }
            else{
                const response = await axios.post(`${backendUrl}/Users/getCategory/${"oversize"}`)
            setProductData(response.data)
            }
        }
        catch (err) {
...
const filterProductType = async (type) => {
        ...
        if (productTypeFilters.includes(type)) {
            ...
            // const response = await axios.post(`${backendUrl}/Users/getCategory/${type}`)
            // setProductData(response.data)
        } else {
