...
const fetchcart = async() =>{
  const response = await axios.get(${backendUrl}/User/Cart/items/${userID},{
    headers:{
      Authorization:${Cookies.token}
    }
  }) 
...
const remove = async(id) =>{
  try{
    const response = await axios.put(${backendUrl}/User/Cart/remove/${userID},{id},{
      headers:{
        Authorization:${Cookies.token}
      }
    })
...
const updateQuantity = async (id, quantity) => {
  try {
    const response = await axios.put(${backendUrl}/User/Cart/updatequantity/${userID}, { id, quantity }, {
      headers: {
        Authorization: ${Cookies.token}
      }
    });
