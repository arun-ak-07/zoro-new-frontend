...
export default function Details() {
  ...
  const getbannedid = async() =>{
      try{
  const response = await axios.get("${backendUrl}/User/UserRegistration/banned",{
    headers:{
...
catch(error)
{
  toast(error.response.data.message,{
    ...
    const fetchcart = async() =>{
      const response = await axios.get(${backendUrl}/User/Cart/ids/${userID},{
        headers:{
          Authorization:${Cookies.token}
        }
      }) 
    ...
    const response = await axios.get(${backendUrl}/Product/getProduct/Details/${productId},{
        headers:{
          Authorization:${Cookies.token}
        }
      })
    ...
    const fetchlikedid = async() =>{
        try{
          const response = await axios.get(${backendUrl}/User/Liked/${userID},{
            headers:{
              Authorization:${Cookies.token}
            }
          })
      ...
      const checkLike = async(itemid) =>{
        ...
        {
          try{
      const response = await axios.put(${backendUrl}/User/Liked/delete/${userID},{itemid},{
        headers:{
          Authorization:${Cookies.token}
        }
      })
      ...
      toast(error.response.data.message,{
        transition: Flip
          ...
          try{
            ...
            const response = await axios.put(${backendUrl}/User/Liked/add/${userID},{itemid},{
              headers:{
                Authorization:${Cookies.token}
              }
            })
 ...
 nav("/Cart")
          ...
          try{
            const response = await axios.put(${backendUrl}/User/Cart/${userID},{id},{
              headers:{
                Authorization:${Cookies.token}
              }
            })
